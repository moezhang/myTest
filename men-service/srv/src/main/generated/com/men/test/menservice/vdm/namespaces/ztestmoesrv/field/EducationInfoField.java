...
package com.men.test.menservice.vdm.namespaces.ztestmoesrv.field;
...
/**
 * Template class to represent entity fields of the Entity {@link com.men.test.menservice.vdm.namespaces.ztestmoesrv.EducationInfo EducationInfo}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class EducationInfoField<FieldT >
    extends EntityField<EducationInfo, FieldT>
    implements EducationInfoSelectable
{
     ...
     */
    public EducationInfoField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public EducationInfoField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
