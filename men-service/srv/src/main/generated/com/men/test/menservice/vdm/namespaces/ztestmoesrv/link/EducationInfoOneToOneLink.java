...
/**
 * Template class to represent entity navigation links of {@link com.men.test.menservice.vdm.namespaces.ztestmoesrv.EducationInfo EducationInfo} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.men.test.menservice.vdm.namespaces.ztestmoesrv.link.EducationInfoLink EducationInfoLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class EducationInfoOneToOneLink<ObjectT extends VdmObject<?> >
    extends EducationInfoLink<ObjectT>
    implements OneToOneLink<EducationInfo, ObjectT>
{
     ...
     */
    public EducationInfoOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<EducationInfo> filter(
        @Nonnull
