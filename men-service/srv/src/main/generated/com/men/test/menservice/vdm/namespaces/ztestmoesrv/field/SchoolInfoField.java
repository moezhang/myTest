...
/**
 * Template class to represent entity fields of the Entity {@link com.men.test.menservice.vdm.namespaces.ztestmoesrv.SchoolInfo SchoolInfo}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class SchoolInfoField<FieldT >
    extends EntityField<SchoolInfo, FieldT>
    implements SchoolInfoSelectable
{
     ...
     */
    public SchoolInfoField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public SchoolInfoField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
